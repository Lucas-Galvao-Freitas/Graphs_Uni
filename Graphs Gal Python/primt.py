...
def prim(graph, start):
    distance = {}
    remaining = heapdict() #heapdict é um dicionario de prioridade (funciona como um priority queue), mas 
    weight = 0             #ele vai escolher o menor valor ao invés do maior.
